...
/* ── 資格と、この仕組みの講座の対応 ──────────
   ...
   ここが空だと、**取得済みなのに「受講してください」と出る**
   （げんきさん 2026-09-09。フルハーネスを登録しているのに、
   マイページに「続きから受講」が出ていた）。
   講座を1本しか出していなかった頃の表が、そのまま残っていた。

   ── 間違える向きを、はっきり決めておく ──
   **入れ忘れ**   … 取得済みなのに講座が出る。うっとうしいだけ。
   **入れ間違い** … 受けていないのに「取得済」になり、
                    **法令で要る教育を受けないまま現場に出る。**
   後者は取り返しがつかない。だから**どの講座か1つに決まらないものは、
   わざと入れない。**下の「入れていないもの」に理由を書いてある。 */
const OURS: Record<string, string> = {
  "SE-001": "kikaitoishi",   // 機械研削用といし
  "SE-002": "toishi",        // 自由研削用といし
  "SE-003": "press",         // 動力プレスの金型等
  "SE-004": "arc",           // アーク溶接等
  "SE-005": "kouatsu",       // 高圧・特別高圧電気
  "SE-006": "teiatsu",       // 低圧電気
  "SE-007": "ev",            // 電気自動車等の整備
  "SE-008": "forklift",      // 1t未満フォークリフト
  "SE-009": "shovel",        // 1t未満ショベルローダー等
  "SE-010": "fuseichi",      // 1t未満不整地運搬車
  "SE-011": "tailgate",      // テールゲートリフター
  "SE-012": "youka",         // 5t未満揚貨装置
  "SE-013": "batsuboku",     // 伐木等機械
  "SE-014": "soukou",        // 走行集材機械
  "SE-015": "kikaishuzai",   // 機械集材装置
  "SE-016": "kanikasen",     // 簡易架線集材装置等
  "SE-017": "chainsaw",      // チェーンソーによる伐木等
  "SE-018": "kogata",        // 小型車両系（整地・運搬・積込み・掘削）
  "SE-019": "kisokouji",     // 小型車両系（基礎工事用）
  "SE-020": "kaitai",        // 小型車両系（解体用）
  "SE-021": "kisokenki",     // 基礎工事用建設機械
  "SE-022": "kisosousa",     // 基礎工事用の作業装置の操作
  "SE-023": "roller",        // ローラー
  "SE-024": "concrete",      // コンクリート打設用機械
  "SE-025": "boring",        // ボーリングマシン
  "SE-026": "jack",          // ジャッキ式つり上げ機械
  "SE-027": "kousho",        // 10m未満高所作業車
  "SE-028": "winch",         // 巻上げ機
  "SE-029": "kidou",         // 軌道装置の動力車
  "SE-030": "boiler",        // 小型ボイラー
  /* 5t未満クレーンと5t以上跨線テルハは、**1つの講座**にまとめてある。
     どちらを持っていても、その講座は受け直さなくてよい */
  "SE-031": "crane",
  "SE-032": "crane",
  "SE-033": "mobilecrane",   // 1t未満移動式クレーン
  "SE-034": "derrick",       // 5t未満デリック
  "SE-035": "kensetsulift",  // 建設用リフト
  "SE-036": "tamakake",      // 1t未満玉掛け
  "SE-037": "gondola",       // ゴンドラ
  "SE-038": "compressor",    // 送気用空気圧縮機の運転
  "SE-039": "soukiroom",     // 作業室への送気の調節
  "SE-040": "kikoushitsu",   // 気こう室の送気・排気の調節
  "SE-041": "soukisensui",   // 潜水作業者への送気の調節
  "SE-042": "kouatsushitsu", // 高圧室内業務
  "SE-043": "tetraalkyl",    // 四アルキル鉛等
  /* SE-044（第一種酸素欠乏）は入れない。下の「入れていないもの」を見ること */
  "SE-045": "sanketsu",      // 第二種＝酸素欠乏・硫化水素危険作業
  "SE-046": "tokushu",       // 特殊化学設備
  "SE-049": "kakunengenshiro", // 原子炉施設で核燃料物質等
  "SE-051": "tokureikinkyu", // 特例緊急作業
  "SE-052": "funjin",        // 特定粉じん作業
  "SE-053": "zuidou",        // ずい道等の掘削等
  "SE-054": "robotkyoji",    // 産業用ロボット教示等
  "SE-055": "robotkensa",    // 産業用ロボット検査等
  "SE-056": "tire",          // タイヤ空気充てん
  /* ダイオキシン類は、3つの業務のどれでも**同じ特別教育**（4時間）。
     講座も1本なので、どれを持っていても受け直さなくてよい */
  "SE-057": "dioxin",
  "SE-058": "dioxin",
  "SE-059": "dioxin",
...
export const NOT_MAPPED: string[] = ["SE-044", "SE-047", "SE-048", "SE-050", "SE-061"];
...
const OTHERS: Qual[] = [
  { id: "OT-001", slug: "foreman-safety-supervisor", name: "職長・安全衛生責任者教育", kind: "その他", courseId: "shokucho" },
