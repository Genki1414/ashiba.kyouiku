...
import {
  JOSEN_DRILL_TEACHER, JOSEN_KUBUN, josenDrillForm, josenDrillPrep, josenDrillSteps,
...
import {
  KAKUNEN_DRILL_TEACHER, KAKUNEN_KUBUN, kakunenDrillForm, kakunenDrillPrep,
  kakunenDrillSteps, kakunenDrillTotalMin, kakunenJitsugi,
} from "./kakunenryou";
import {
...
const GUIDES: Record<string, DrillGuide> = {
  ...
  josendojo: {
    courseId: "josendojo",
    subject: josenJitsugi(JOSEN_KUBUN.dojo).name,
    scope: josenJitsugi(JOSEN_KUBUN.dojo).scope,
    legalMin: josenJitsugi(JOSEN_KUBUN.dojo).legalMin,
    steps: josenDrillSteps(JOSEN_KUBUN.dojo),
    totalMin: josenDrillTotalMin(JOSEN_KUBUN.dojo),
    teacher: JOSEN_DRILL_TEACHER,
    prep: josenDrillPrep(JOSEN_KUBUN.dojo),
    keepYears: 3,
    form: josenDrillForm(JOSEN_KUBUN.dojo),
  },
  josenshushu: {
    courseId: "josenshushu",
    subject: josenJitsugi(JOSEN_KUBUN.shushu).name,
    scope: josenJitsugi(JOSEN_KUBUN.shushu).scope,
    legalMin: josenJitsugi(JOSEN_KUBUN.shushu).legalMin,
    steps: josenDrillSteps(JOSEN_KUBUN.shushu),
    totalMin: josenDrillTotalMin(JOSEN_KUBUN.shushu),
    teacher: JOSEN_DRILL_TEACHER,
    prep: josenDrillPrep(JOSEN_KUBUN.shushu),
    keepYears: 3,
    form: josenDrillForm(JOSEN_KUBUN.shushu),
  },
  josenhaiki: {
    courseId: "josenhaiki",
    subject: josenJitsugi(JOSEN_KUBUN.haiki).name,
    scope: josenJitsugi(JOSEN_KUBUN.haiki).scope,
    legalMin: josenJitsugi(JOSEN_KUBUN.haiki).legalMin,
    steps: josenDrillSteps(JOSEN_KUBUN.haiki),
    totalMin: josenDrillTotalMin(JOSEN_KUBUN.haiki),
    teacher: JOSEN_DRILL_TEACHER,
    prep: josenDrillPrep(JOSEN_KUBUN.haiki),
    keepYears: 3,
    form: josenDrillForm(JOSEN_KUBUN.haiki),
  },
  josentokutei: {
    courseId: "josentokutei",
    subject: josenJitsugi(JOSEN_KUBUN.tokutei).name,
    scope: josenJitsugi(JOSEN_KUBUN.tokutei).scope,
    legalMin: josenJitsugi(JOSEN_KUBUN.tokutei).legalMin,
    steps: josenDrillSteps(JOSEN_KUBUN.tokutei),
    totalMin: josenDrillTotalMin(JOSEN_KUBUN.tokutei),
    teacher: JOSEN_DRILL_TEACHER,
    prep: josenDrillPrep(JOSEN_KUBUN.tokutei),
    keepYears: 3,
    form: josenDrillForm(JOSEN_KUBUN.tokutei),
  },
  josentokuteigai: {
    courseId: "josentokuteigai",
    subject: josenJitsugi(JOSEN_KUBUN.tokuteigai).name,
    scope: josenJitsugi(JOSEN_KUBUN.tokuteigai).scope,
    legalMin: josenJitsugi(JOSEN_KUBUN.tokuteigai).legalMin,
    steps: josenDrillSteps(JOSEN_KUBUN.tokuteigai),
    totalMin: josenDrillTotalMin(JOSEN_KUBUN.tokuteigai),
    teacher: JOSEN_DRILL_TEACHER,
  ...
  kakunenkakou: {
    ...
    subject: kakunenJitsugi(KAKUNEN_KUBUN.kakou).name,
    scope: kakunenJitsugi(KAKUNEN_KUBUN.kakou).scope,
    legalMin: kakunenJitsugi(KAKUNEN_KUBUN.kakou).legalMin,
    steps: kakunenDrillSteps(KAKUNEN_KUBUN.kakou),
    totalMin: kakunenDrillTotalMin(KAKUNEN_KUBUN.kakou),
    teacher: KAKUNEN_DRILL_TEACHER,
    prep: kakunenDrillPrep(KAKUNEN_KUBUN.kakou),
    keepYears: 3,
    form: kakunenDrillForm(KAKUNEN_KUBUN.kakou),
  },
  kakunensaishori: {
    courseId: "kakunensaishori",
    subject: kakunenJitsugi(KAKUNEN_KUBUN.saishori).name,
    scope: kakunenJitsugi(KAKUNEN_KUBUN.saishori).scope,
    legalMin: kakunenJitsugi(KAKUNEN_KUBUN.saishori).legalMin,
    steps: kakunenDrillSteps(KAKUNEN_KUBUN.saishori),
    totalMin: kakunenDrillTotalMin(KAKUNEN_KUBUN.saishori),
    teacher: KAKUNEN_DRILL_TEACHER,
    prep: kakunenDrillPrep(KAKUNEN_KUBUN.saishori),
    keepYears: 3,
    form: kakunenDrillForm(KAKUNEN_KUBUN.saishori),
  },
  kakunenshiyou: {
    courseId: "kakunenshiyou",
    subject: kakunenJitsugi(KAKUNEN_KUBUN.shiyou).name,
    scope: kakunenJitsugi(KAKUNEN_KUBUN.shiyou).scope,
    legalMin: kakunenJitsugi(KAKUNEN_KUBUN.shiyou).legalMin,
    steps: kakunenDrillSteps(KAKUNEN_KUBUN.shiyou),
    totalMin: kakunenDrillTotalMin(KAKUNEN_KUBUN.shiyou),
    teacher: KAKUNEN_DRILL_TEACHER,
    prep: kakunenDrillPrep(KAKUNEN_KUBUN.shiyou),
    keepYears: 3,
    form: kakunenDrillForm(KAKUNEN_KUBUN.shiyou),
  },
  kakunengenshiro: {
    courseId: "kakunengenshiro",
    subject: kakunenJitsugi(KAKUNEN_KUBUN.genshiro).name,
    scope: kakunenJitsugi(KAKUNEN_KUBUN.genshiro).scope,
    legalMin: kakunenJitsugi(KAKUNEN_KUBUN.genshiro).legalMin,
    steps: kakunenDrillSteps(KAKUNEN_KUBUN.genshiro),
    totalMin: kakunenDrillTotalMin(KAKUNEN_KUBUN.genshiro),
    teacher: KAKUNEN_DRILL_TEACHER,
    prep: kakunenDrillPrep(KAKUNEN_KUBUN.genshiro),
    keepYears: 3,
    form: kakunenDrillForm(KAKUNEN_KUBUN.genshiro),
  },
  boiler: {
    courseId: "boiler",
