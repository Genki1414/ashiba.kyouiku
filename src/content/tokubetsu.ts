...
export type Tokubetsu = {
  ...
  variants?: {
    ...
    jitsugiMin?: number;
    note?: string;
    /** その区分の講座。**区分ごとに一本ずつ**講座にしたときに入れる。
        全部の区分に入るか、全部に入らないか（半分だけは無し） */
    courseId?: string;
    /** その区分の科目・中欄・時間（告示のその区分の行のまま）。講座と突き合わせる */
    gakka?: { name: string; scope: string; min: number }[];
    jitsugi?: { name: string; scope: string; min: number }[];
  }[];
...
export const TOKUBETSU: Tokubetsu[] = [
  ...
  },
  {
    ...
    /* **区分ごとに一本ずつ、五本の講座にした**（2026年9月6日・docs/82）。
       区分の gakka・jitsugi は、告示のその区分の行をそのまま写したもの。
       tests/tokubetsu.ts が、区分の講座の科目・中欄・時間をここと突き合わせる */
    variants: [
      {
        name: "土壌等の除染等",
        gakkaMin: 240,
        ...
        gakka: [
          ...
          {
            name: "除染等作業の方法に関する知識",
            scope: "土壌等の除染等の業務に係る作業の方法及び順序　放射線測定の方法　外部放射線による線量当量率の監視の方法　汚染防止措置の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法",
            min: 60,
          },
          {
            name: "除染等作業に使用する機械等の構造及び取扱いの方法に関する知識",
            scope: "土壌等の除染等の業務に係る作業に使用する機械等の構造及び取扱いの方法",
            min: 60,
          },
          {
            name: "関係法令",
        ...
        jitsugi: [
          {
            name: "除染等作業の方法及び使用する機械等の取扱い",
            scope: "土壌等の除染等の業務に係る作業　放射線測定器の取扱い　外部放射線による線量当量率の監視　汚染防止措置　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い　土壌等の除染等の業務に係る作業に使用する機械等の取扱い",
            min: 90,
          },
        ],
      },
      {
        ...
        gakka: [
          ...
          {
            name: "除染等作業の方法に関する知識",
            scope: "除去土壌の収集等に係る業務に係る作業の方法及び順序　放射線測定の方法　外部放射線による線量当量率の監視の方法　汚染防止措置の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法",
            min: 60,
          },
          {
            name: "除染等作業に使用する機械等の構造及び取扱いの方法に関する知識",
            scope: "除去土壌の収集等に係る業務に係る作業に使用する機械等の構造及び取扱いの方法",
            min: 60,
          },
          {
            name: "関係法令",
        ...
        jitsugi: [
          {
            name: "除染等作業の方法及び使用する機械等の取扱い",
            scope: "除去土壌の収集等に係る業務に係る作業　放射線測定器の取扱い　外部放射線による線量当量率の監視　汚染防止措置　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い　除去土壌の収集等に係る業務に係る作業に使用する機械等の取扱い",
            min: 90,
          },
        ],
      },
      {
        ...
        gakka: [
          ...
          {
            name: "除染等作業の方法に関する知識",
            scope: "汚染廃棄物の収集等に係る業務に係る作業の方法及び順序　放射線測定の方法　外部放射線による線量当量率の監視の方法　汚染防止措置の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法",
            min: 60,
          },
          {
            name: "除染等作業に使用する機械等の構造及び取扱いの方法に関する知識",
            scope: "汚染廃棄物の収集等に係る業務に係る作業に使用する機械等の構造及び取扱いの方法",
            min: 60,
          },
          {
            name: "関係法令",
        ...
        jitsugi: [
          {
            name: "除染等作業の方法及び使用する機械等の取扱い",
            scope: "汚染廃棄物の収集等に係る業務に係る作業　放射線測定器の取扱い　外部放射線による線量当量率の監視　汚染防止措置　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い　汚染廃棄物の収集等に係る業務に係る作業に使用する機械等の取扱い",
            min: 90,
          },
        ],
      },
      {
        ...
        gakka: [
          ...
          {
            name: "除染等作業の方法に関する知識",
            scope: "特定汚染土壌等取扱業務に係る作業の方法及び順序　放射線測定の方法　外部放射線による線量当量率の監視の方法　汚染防止措置の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法",
            min: 60,
          },
          {
            name: "除染等作業に使用する機械等の構造及び取扱いの方法に関する知識（特定汚染土壌等取扱業務に労働者を就かせるときは、特定汚染土壌等取扱作業に使用する機械等の名称及び用途に関する知識に限る。）",
            scope: "当該業務に係る作業に使用する機械等の名称及び用途",
            min: 30,
          },
          {
            name: "関係法令",
        ...
        jitsugi: [
          {
            name: "除染等作業の方法及び使用する機械等の取扱い（特定汚染土壌等取扱業務に労働者を就かせるときは、特定汚染土壌等取扱作業の方法に限る。）",
            scope: "特定汚染土壌等取扱業務に係る作業　放射線測定器の取扱い　外部放射線による線量当量率の監視　汚染防止措置　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い",
            min: 60,
          },
        ],
      },
      {
        ...
        gakka: [
          {
            name: "電離放射線の生体に与える影響及び被ばく線量の管理の方法に関する知識",
            scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響　被ばく限度",
            min: 60,
          },
          {
            name: "除染等作業の方法に関する知識",
            scope: "特定汚染土壌等取扱業務に係る作業の方法及び順序　放射線測定の方法　汚染防止措置の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法",
            min: 60,
          },
          {
            name: "除染等作業に使用する機械等の構造及び取扱いの方法に関する知識（特定汚染土壌等取扱業務に労働者を就かせるときは、特定汚染土壌等取扱作業に使用する機械等の名称及び用途に関する知識に限る。）",
        ...
        jitsugi: [
          {
            name: "除染等作業の方法及び使用する機械等の取扱い（特定汚染土壌等取扱業務に労働者を就かせるときは、特定汚染土壌等取扱作業の方法に限る。）",
            scope: "特定汚染土壌等取扱業務に係る作業　放射線測定器の取扱い　汚染防止措置　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い",
            min: 60,
          },
        ],
      },
    ...
    checked: true,
    checkedOn: KOKUJI_125_469_ON,
    doc: "docs/82-除染等業務を業務区分ごとに五本にした記録.md",
  },
  {
    no: 62,
...
/** もう受けられるか */
export const isReady = (t: Tokubetsu): boolean =>
  !!t.courseId || ((t.variants ?? []).length > 0 && t.variants!.every((v) => !!v.courseId));

/** 講座にしてある講座IDの一覧。区分ごとに講座にした行は、区分の分だけ返す */
export const courseIdsOf = (t: Tokubetsu): string[] =>
  t.courseId ? [t.courseId] : (t.variants ?? []).map((v) => v.courseId).filter((x): x is string => !!x);
...
export const tokubetsuOfCourse = (courseId: string): Tokubetsu | null =>
  TOKUBETSU.find((t) => courseIdsOf(t).includes(courseId)) ?? null;
