...
export const SOURCES: Record<string, { name: string; url: string }> = {
  kitei: {
    /* 告示なので e-Gov には無い。厚労省の法令等データベースか、
       安全衛生情報センター（中災防）にある。
       jaish は表が行ごとに読める形で載っている */
    name: "安全衛生特別教育規程",
...
/** 電離則の三つの告示（エックス線・ガンマ線／事故由来廃棄物等処分／特例緊急作業）を読んだ日。
    げんきさんが jaish（安全衛生情報センター）の画面写しと本文を送ってくれた（docs/83）。
    **核燃料物質等取扱業務特別教育規程（no.48・49）は、表がリンクの先にあって写しに無い。**まだ */
export const KOKUJI_DENRI_ON = "2026-09-06";

/** **安全衛生特別教育規程（昭和47年労働省告示第92号）の全文を見た日。**

    げんきさんが条文をそのまま写して渡してくれた（2026-09-07）。
    この告示ひとつで、目録40行ぶんの科目・範囲・時間が決まっている。
    40行すべて、うちの目録と学科・実技の時間が一致した（ちがい0）。

    **足場（no.63）の条がここで初めて分かった。第22条。**
    それまでは東京労働局のまとめしか出どころが無く、66行のうち
    裏取りの記録が無い唯一の行だった（docs/94 → docs/95 で解消）。 */
export const KOKUJI_92_ON = "2026-09-07";
...
export const TOKUBETSU: Tokubetsu[] = [
  ...
  },
  {
    ...
    /* **告示の表で確かめた**（2026年9月6日・docs/83）。学科だけ。
       科目2「構造及び取扱いの方法」が、**エックス線装置を扱う人の行（1時間30分）と
       ガンマ線照射装置を扱う人の行（1時間30分）に分かれている。**
       片方だけなら270分。**両方を扱う人は両方の行を受けるので360分。**
       行の時間は、区分のうちいちばん長いもの（両方）。区分ごとの時間は variants */
    gakkaMin: 360,
    jitsugiMin: 0,
    basis: "電離放射線障害防止規則第52条の5第1項／エックス線装置及びガンマ線照射装置取扱業務特別教育規程",
    gakka: [
      { name: "エックス線装置又はガンマ線照射装置を取り扱う業務に係る作業の方法に関する知識", scope: "作業の手順　電離放射線の測定　被ばく防止の方法　事故時の措置", min: 90 },
      { name: "エックス線装置又はガンマ線照射装置の構造及び取扱いの方法に関する知識", scope: "エックス線装置の原理　エックス線装置のエックス線管、高電圧発生器及び制御器の構造及び機能　エックス線装置の操作及び点検　ガンマ線照射装置の種類及び型式　線源容器の構造及び機能　放射線源送出し装置又は放射線源の位置を調整する遠隔操作装置の構造及び機能　放射線源の構造及び放射性物質の性質　ガンマ線照射装置の操作及び点検", min: 180 },
      { name: "電離放射線の生体に与える影響", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響", min: 30 },
      { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離放射線障害防止規則中の関係条項", min: 60 },
    ],
    jitsugi: [],
    variants: [
      {
        ...
        gakka: [
          { name: "エックス線装置又はガンマ線照射装置を取り扱う業務に係る作業の方法に関する知識", scope: "作業の手順　電離放射線の測定　被ばく防止の方法　事故時の措置", min: 90 },
          { name: "エックス線装置又はガンマ線照射装置の構造及び取扱いの方法に関する知識", scope: "エックス線装置の原理　エックス線装置のエックス線管、高電圧発生器及び制御器の構造及び機能　エックス線装置の操作及び点検", min: 90 },
          { name: "電離放射線の生体に与える影響", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響", min: 30 },
          { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離放射線障害防止規則中の関係条項", min: 60 },
        ],
        jitsugi: [],
      },
      {
        ...
        gakka: [
          { name: "エックス線装置又はガンマ線照射装置を取り扱う業務に係る作業の方法に関する知識", scope: "作業の手順　電離放射線の測定　被ばく防止の方法　事故時の措置", min: 90 },
          { name: "エックス線装置又はガンマ線照射装置の構造及び取扱いの方法に関する知識", scope: "ガンマ線照射装置の種類及び型式　線源容器の構造及び機能　放射線源送出し装置又は放射線源の位置を調整する遠隔操作装置の構造及び機能　放射線源の構造及び放射性物質の性質　ガンマ線照射装置の操作及び点検", min: 90 },
          { name: "電離放射線の生体に与える影響", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響", min: 30 },
          { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離放射線障害防止規則中の関係条項", min: 60 },
        ],
        jitsugi: [],
    ...
    /* 写しは、題名と科目名が**令和8年4月1日施行の改正後**のもの（「透過写真撮影」ではなく
       「エックス線装置又はガンマ線照射装置を取り扱う業務」）。
       **改正文（令和7年10月29日厚生労働省告示第287号）抄も確かめた**（2026年9月6日・docs/83）。
       **令和8年4月1日から適用する。**ただし、適用の日以後に、
       **改正前の透過写真撮影業務特別教育規程による特別の教育を受けた者**を、
       エックス線装置又はガンマ線照射装置を用いて行う**透過写真の撮影の業務**
       （令和7年厚生労働省令第108号による改正前の安衛則第36条第28号の業務）につかせるときは、
       **改めて特別の教育を行うことを要しない。**
       ＝**前の教育を受けた人は、透過写真の撮影に限っては、受け直さなくてよい。**
       **透過写真の撮影以外の取扱い（新しく対象になった業務）には、この教育が要る** */
    src: "xray",
    from: "2026-04-01",
    fullText: true,
    checked: true,
  ...
  },
  {
    ...
    /* **告示第1条第2項・第3項の表で確かめた**（2026年9月6日・docs/87）。
       **三つの区分（加工施設／再処理施設／使用施設等）とも、学科330分・実技120分。**
       科目2と科目3と実技の中欄が、区分ごとに違う。
       行の科目は、加工施設の行を写したもの。**区分ごとの正本は variants** */
    gakka: [
      { name: "核燃料物質若しくは使用済燃料又はこれらによって汚染された物に関する知識", scope: "核燃料物質又は使用済燃料の種類及び性状（臨界に関することを含む。）　核燃料物質又は使用済燃料によって汚染された物（原子核分裂生成物を含む。以下同じ。）の種類及び性状", min: 60 },
      { name: "加工施設、再処理施設又は使用施設等における作業の方法に関する知識", scope: "管理区域に関すること　核燃料物質又はこれによって汚染された物の加工、運搬、貯蔵及び廃棄の作業の方法及び順序（偶発的な臨界の防止に関することを含む。）　核燃料物質によって汚染された設備の保守及び点検の作業の方法及び順序　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去の方法　異常な事態が発生した場合における応急の措置の方法", min: 90 },
      { name: "加工施設、再処理施設又は使用施設等に係る設備の構造及び取扱いの方法に関する知識", scope: "加工設備、放射性廃棄物の廃棄設備及びその他の設備の構造及び取扱いの方法", min: 90 },
      { name: "電離放射線の生体に与える影響", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響", min: 30 },
      { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 60 },
    ],
    jitsugi: [
      { name: "加工施設、再処理施設又は使用施設等における作業の方法及び同施設に係る設備の取扱い", scope: "管理区域への立入り及び退去の手順　核燃料物質又はこれによって汚染された物の加工、運搬、貯蔵及び廃棄の作業（偶発的な臨界の防止に関することを含む。）　核燃料物質によって汚染された設備の保守及び点検の作業　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去　加工設備、放射性廃棄物の廃棄設備及びその他の設備の取扱い　異常な事態が発生した場合における応急の措置", min: 120 },
    ],
    variants: [
      {
        name: "加工施設",
        gakkaMin: 330,
        jitsugiMin: 120,
        note: "加工施設の管理区域内において、核燃料物質又はこれによって汚染された物を取り扱う業務",
      ...
      },
      {
        ...
        gakkaMin: 330,
        jitsugiMin: 120,
        note: "再処理施設の管理区域内において、核燃料物質若しくは使用済燃料又はこれらによって汚染された物を取り扱う業務",
        courseId: "kakunensaishori",
        gakka: [
          { name: "核燃料物質若しくは使用済燃料又はこれらによって汚染された物に関する知識", scope: "核燃料物質又は使用済燃料の種類及び性状（臨界に関することを含む。）　核燃料物質又は使用済燃料によって汚染された物（原子核分裂生成物を含む。以下同じ。）の種類及び性状", min: 60 },
          { name: "加工施設、再処理施設又は使用施設等における作業の方法に関する知識", scope: "管理区域に関すること　核燃料物質若しくは使用済燃料又はこれらによって汚染された物の再処理、運搬、貯蔵及び廃棄の作業の方法及び順序（偶発的な臨界の防止に関することを含む。）　核燃料物質又は使用済燃料によって汚染された設備の保守及び点検の作業の方法及び順序　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去の方法　異常な事態が発生した場合における応急の措置の方法", min: 90 },
          { name: "加工施設、再処理施設又は使用施設等に係る設備の構造及び取扱いの方法に関する知識", scope: "再処理設備、放射性廃棄物の廃棄設備及びその他の設備の構造及び取扱いの方法", min: 90 },
          { name: "電離放射線の生体に与える影響", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響", min: 30 },
          { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 60 },
        ],
        jitsugi: [
          { name: "加工施設、再処理施設又は使用施設等における作業の方法及び同施設に係る設備の取扱い", scope: "管理区域への立入り及び退去の手順　核燃料物質若しくは使用済燃料又はこれらによって汚染された物の再処理、運搬、貯蔵及び廃棄の作業（偶発的な臨界の防止に関することを含む。）　核燃料物質又は使用済燃料によって汚染された設備の保守及び点検の作業　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去　再処理設備、放射性廃棄物の廃棄設備及びその他の設備の取扱い　異常な事態が発生した場合における応急の措置", min: 120 },
        ],
      },
      {
        name: "使用施設等",
        gakkaMin: 330,
        jitsugiMin: 120,
        note: "使用施設等の管理区域内において、核燃料物質若しくは使用済燃料又はこれらによって汚染された物を取り扱う業務",
        courseId: "kakunenshiyou",
        gakka: [
          { name: "核燃料物質若しくは使用済燃料又はこれらによって汚染された物に関する知識", scope: "核燃料物質又は使用済燃料の種類及び性状（臨界に関することを含む。）　核燃料物質又は使用済燃料によって汚染された物（原子核分裂生成物を含む。以下同じ。）の種類及び性状", min: 60 },
          { name: "加工施設、再処理施設又は使用施設等における作業の方法に関する知識", scope: "管理区域に関すること　核燃料物質若しくは使用済燃料又はこれらによって汚染された物の使用、運搬、貯蔵及び廃棄の作業の方法及び順序（偶発的な臨界の防止に関することを含む。）　核燃料物質又は使用済燃料によって汚染された設備の保守及び点検の作業の方法及び順序　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去の方法　異常な事態が発生した場合における応急の措置の方法", min: 90 },
          { name: "加工施設、再処理施設又は使用施設等に係る設備の構造及び取扱いの方法に関する知識", scope: "放射線遮へいのための設備、気密設備及びその他の設備の構造及び取扱いの方法", min: 90 },
          { name: "電離放射線の生体に与える影響", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響", min: 30 },
          { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 60 },
        ],
        jitsugi: [
          { name: "加工施設、再処理施設又は使用施設等における作業の方法及び同施設に係る設備の取扱い", scope: "管理区域への立入り及び退去の手順　核燃料物質若しくは使用済燃料又はこれらによって汚染された物の使用、運搬、貯蔵及び廃棄の作業（偶発的な臨界の防止に関することを含む。）　核燃料物質又は使用済燃料によって汚染された設備の保守及び点検の作業　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去　放射線遮へいのための設備、気密設備及びその他の設備の取扱い　異常な事態が発生した場合における応急の措置", min: 120 },
        ],
      },
    ],
    /* 元は学科690分・実技360分（労働局のまとめ）だったが、告示は330分・120分。
       訂正版の講座マスターと同じ。告示が来て決着した */
    src: "roudoukyoku",
    fromMaster: true,
    fullText: true,
    checked: true,
  ...
  },
  {
    ...
    /* **告示第2条第2項・第3項の表で確かめた**（2026年9月6日・docs/87）。
       **業務区分は無い。**加工施設等（no.48）と違って、原子炉施設の一本 */
    gakka: [
      { name: "核燃料物質若しくは使用済燃料又はこれらによって汚染された物に関する知識", scope: "核燃料物質又は使用済燃料の種類及び性状　核燃料物質又は使用済燃料によって汚染された物の種類及び性状", min: 30 },
      { name: "原子炉施設における作業の方法に関する知識", scope: "管理区域に関すること　核燃料物質若しくは使用済燃料又はこれらによって汚染された物の運搬、貯蔵及び廃棄の作業の方法及び順序　核燃料物質又は使用済燃料によって汚染された設備の保守及び点検の作業の方法及び順序　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去の方法　異常な事態が発生した場合における応急の措置の方法", min: 90 },
      { name: "原子炉施設に係る設備の構造及び取扱いの方法に関する知識", scope: "原子炉、放射性廃棄物の廃棄設備及びその他の設備の構造及び取扱いの方法", min: 90 },
      { name: "電離放射線の生体に与える影響", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響", min: 30 },
      { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 60 },
    ],
    jitsugi: [
      { name: "原子炉施設における作業の方法及び同施設に係る設備の取扱い", scope: "管理区域への立入り及び退去の手順　核燃料物質若しくは使用済燃料又はこれらによって汚染された物の運搬、貯蔵及び廃棄の作業　核燃料物質又は使用済燃料によって汚染された設備の保守及び点検の作業　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去　原子炉、放射性廃棄物の廃棄設備及びその他の設備の取扱い　異常な事態が発生した場合における応急の措置", min: 120 },
    ],
    src: "roudoukyoku",
    checked: true,
    fromMaster: true,
  ...
  },
  {
    ...
    /* **告示第2条・第3条の表で確かめた**（2026年9月6日・docs/83）。
       **三つの区分（破砕等／焼却／埋立て）とも、学科300分・実技120分。**
       科目2の二つ目の項目と、科目3と、実技の中欄が、区分ごとに違う。
       行の科目は、破砕等の行を写したもの。**区分ごとの正本は variants** */
    gakka: [
      { name: "事故由来廃棄物等に関する知識", scope: "事故由来廃棄物等の種類及び性状", min: 30 },
      { name: "事故由来廃棄物等の処分の業務に係る作業の方法に関する知識", scope: "管理区域に関すること　事故由来廃棄物等の破砕等、運搬及び貯蔵の作業の方法及び順序　事故由来廃棄物等によって汚染された設備の保守及び点検の作業の方法及び順序　放射線測定の方法　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法", min: 90 },
      { name: "事故由来廃棄物等の処分の業務に係る作業に使用する設備の構造及び取扱いの方法に関する知識", scope: "破砕等設備、事故由来廃棄物等取扱施設の設備及びその他の設備の構造及び取扱いの方法", min: 60 },
      { name: "電離放射線の生体に与える影響及び被ばく線量の管理の方法に関する知識", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響　被ばく限度及び被ばく線量測定の方法　被ばく線量測定の結果の確認及び記録等の方法", min: 60 },
      { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 60 },
    ],
    jitsugi: [
      { name: "事故由来廃棄物等の処分の業務に係る作業の方法及び使用する設備の取扱い", scope: "管理区域への立入り及び退去の手順　事故由来廃棄物等の破砕等、運搬及び貯蔵の作業　事故由来廃棄物等によって汚染された設備の保守及び点検の作業　放射線測定器の取扱い　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い　破砕等設備、事故由来廃棄物等取扱施設の設備及びその他の設備の取扱い　異常な事態が発生した場合における応急の措置", min: 120 },
    ],
    variants: [
      {
        name: "破砕等",
      ...
      },
      {
        ...
        gakka: [
          { name: "事故由来廃棄物等に関する知識", scope: "事故由来廃棄物等の種類及び性状", min: 30 },
          { name: "事故由来廃棄物等の処分の業務に係る作業の方法に関する知識", scope: "管理区域に関すること　事故由来廃棄物等の焼却、運搬及び貯蔵の作業の方法及び順序　事故由来廃棄物等によって汚染された設備の保守及び点検の作業の方法及び順序　放射線測定の方法　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法", min: 90 },
          { name: "事故由来廃棄物等の処分の業務に係る作業に使用する設備の構造及び取扱いの方法に関する知識", scope: "焼却炉及びその他の設備の構造及び取扱いの方法", min: 60 },
          { name: "電離放射線の生体に与える影響及び被ばく線量の管理の方法に関する知識", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響　被ばく限度及び被ばく線量測定の方法　被ばく線量測定の結果の確認及び記録等の方法", min: 60 },
          { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 60 },
        ],
        jitsugi: [
          { name: "事故由来廃棄物等の処分の業務に係る作業の方法及び使用する設備の取扱い", scope: "管理区域への立入り及び退去の手順　事故由来廃棄物等の焼却、運搬及び貯蔵の作業　事故由来廃棄物等によって汚染された設備の保守及び点検の作業　放射線測定器の取扱い　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い　焼却炉及びその他の設備の取扱い　異常な事態が発生した場合における応急の措置", min: 120 },
        ],
      },
      {
        name: "埋立て",
        ...
        gakka: [
          { name: "事故由来廃棄物等に関する知識", scope: "事故由来廃棄物等の種類及び性状", min: 30 },
          { name: "事故由来廃棄物等の処分の業務に係る作業の方法に関する知識", scope: "管理区域に関すること　事故由来廃棄物等の運搬、貯蔵及び埋立ての作業の方法及び順序　事故由来廃棄物等によって汚染された設備の保守及び点検の作業の方法及び順序　放射線測定の方法　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去の方法　身体等の汚染の状態の検査及び汚染の除去の方法　保護具の性能及び使用方法　異常な事態が発生した場合における応急の措置の方法", min: 90 },
          { name: "事故由来廃棄物等の処分の業務に係る作業に使用する設備の構造及び取扱いの方法に関する知識", scope: "集排水設備、遮水工及びその他の設備の構造及び取扱いの方法", min: 60 },
          { name: "電離放射線の生体に与える影響及び被ばく線量の管理の方法に関する知識", scope: "電離放射線の種類及び性質　電離放射線が生体の細胞、組織、器官及び全身に与える影響　被ばく限度及び被ばく線量測定の方法　被ばく線量測定の結果の確認及び記録等の方法", min: 60 },
          { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 60 },
        ],
        jitsugi: [
          { name: "事故由来廃棄物等の処分の業務に係る作業の方法及び使用する設備の取扱い", scope: "管理区域への立入り及び退去の手順　事故由来廃棄物等の運搬、貯蔵及び埋立ての作業　事故由来廃棄物等によって汚染された設備の保守及び点検の作業　放射線測定器の取扱い　外部放射線による線量当量率及び空気中の放射性物質の濃度の監視　天井、床、壁、設備等の表面の汚染の状態の検査及び汚染の除去　身体等の汚染の状態の検査及び汚染の除去　保護具の取扱い　集排水設備、遮水工及びその他の設備の取扱い　異常な事態が発生した場合における応急の措置", min: 120 },
        ],
      },
    ],
    /* 元は学科600分・実技360分（労働局のまとめ）だったが、告示は300分・120分。
       訂正版の講座マスターと同じ。告示が来て決着した */
    src: "roudoukyoku",
    fromMaster: true,
    fullText: true,
  ...
  },
  {
    ...
    /* **告示第2条・第3条の表で確かめた**（2026年9月6日・docs/83）。
       写しは**令和8年2月20日厚生労働省告示第44号による改正後**で、附則（令和8年4月1日から適用）まで見えている。
       科目1の中欄が十項目、科目3が七項目。関係法令は「〇・五時間」と書いてある */
    gakka: [
      { name: "特例緊急作業の方法に関する知識", scope: "原子炉の炉心の著しい損傷その他の重大な事故又は当該重大な事故に至るおそれがある事故（以下「重大事故等」という。）に対処するための作業の方法　特例緊急作業（電離則第七条の三第三項に規定する特例緊急作業をいう。以下同じ。）における必要な体制の整備　特例緊急作業における連絡の方法　特例緊急作業における放射線測定の方法　特例緊急作業における外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　特例緊急作業を行う場所の汚染の状態の検査及び汚染の影響の低減のために必要な措置の方法　特例緊急作業における身体等の汚染の状態の検査及び汚染の除去の方法　特例緊急作業に使用する保護具の性能及び使用方法　応急手当の方法　重大事故等及び重大事故等への対処の事例", min: 180 },
      { name: "特例緊急作業で使用する施設及び設備の構造及び取扱いの方法に関する知識", scope: "重大事故等に対処するための機能を有する施設及び設備の構造及び取扱いの方法", min: 120 },
      { name: "電離放射線の生体に与える影響、健康管理の方法及び被ばく線量の管理の方法に関する知識", scope: "電離放射線の種類及び性質　特例緊急作業において電離放射線が生体の細胞、組織、器官及び全身に与える影響　特例緊急作業における健康管理の方法　特例緊急被ばく限度（電離則第七条の二第一項に規定する特例緊急被ばく限度をいう。）　特例緊急作業における被ばく線量測定の方法　特例緊急作業における被ばく線量測定の結果の確認、記録等の方法　電離則第四条第一項に規定する被ばく限度を超えた特例緊急作業に従事する労働者に係る被ばく線量の管理の方法", min: 60 },
      { name: "関係法令", scope: "労働安全衛生法、労働安全衛生法施行令、労働安全衛生規則及び電離則中の関係条項", min: 30 },
    ],
    jitsugi: [
      { name: "特例緊急作業の方法", scope: "重大事故等に対処するための作業の方法　特例緊急作業における放射線測定器の取扱い　特例緊急作業における外部放射線による線量当量率及び空気中の放射性物質の濃度の監視の方法　特例緊急作業を行う場所の汚染の状態の検査及び汚染の影響の低減のために必要な措置の方法　特例緊急作業における身体等の汚染の状態の検査及び汚染の除去の方法　特例緊急作業に使用する保護具の取扱い　応急手当の方法", min: 180 },
      { name: "特例緊急作業で使用する施設及び設備の取扱い", scope: "重大事故等に対処するための機能を有する施設及び設備の取扱い", min: 180 },
    ],
    src: "roudoukyoku",
    checked: true,
    fromMaster: true,
     ...
     **規程の何条かは、まだ条文で見ていないので書かない**（前後の行は第21条・第23条・第24条） */
  {
    ...
    gakkaMin: 360,
    jitsugiMin: 0,
    basis: "労働安全衛生規則第36条第39号／安全衛生特別教育規程第22条",
    src: "kitei",
    courseId: "ashiba",
    checked: true,
    fullText: true,
    checkedOn: KOKUJI_92_ON,
    doc: "docs/95-足場の根拠と裏取り.md",
    /* 告示第22条第2項の表。げんきさんが写した条文のとおり（2026-09-07）。
       **実技の項は無い。**条文が「学科教育により行うものとする」で切れている */
    gakka: [
      {
        name: "足場及び作業の方法に関する知識",
        scope: "足場の種類、材料、構造及び組立図　足場の組立て、解体及び変更の作業の方法　点検及び補修　登り桟橋、朝顔等の構造並びにこれらの組立て、解体及び変更の作業の方法",
        min: 180,
      },
      {
        name: "工事用設備、機械、器具、作業環境等に関する知識",
        scope: "工事用設備及び機械の取扱い　器具及び工具　悪天候時における作業の方法",
        min: 30,
      },
      {
        name: "労働災害の防止に関する知識",
        scope: "墜落防止のための設備　落下物による危険防止のための措置　保護具の使用方法及び保守点検の方法　感電防止のための措置　その他作業に伴う災害及びその防止方法",
        min: 90,
      },
      { name: "関係法令", scope: "法、令及び安衛則中の関係条項", min: 60 },
    ],
  },
