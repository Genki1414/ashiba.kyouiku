...
export const TOKUBETSU: Tokubetsu[] = [
  ...
  },
  {
    ...
    jitsugiMin: 120,
    basis:
      "高気圧作業安全衛生規則（昭和47年労働省令第40号）第11条第1項第1号／高気圧業務特別教育規程（昭和47年労働省告示第129号）",
    /* **教育すべき事項は、規則第11条第2項の表で確かめた**（2026年9月5日）。
       科目・範囲・時間を決めているのは告示のほう。**告示はまだ見ていない**ので、
       時間は労働局のまとめのまま（確かめた印は付けない） */
    jikou: [
      "圧気工法の知識に関すること。",
      "送気設備の構造及び取扱いに関すること。",
      "高気圧障害の知識に関すること。",
  ...
  },
  {
    ...
    jitsugiMin: 120,
    basis:
      "高気圧作業安全衛生規則（昭和47年労働省令第40号）第11条第1項第2号／高気圧業務特別教育規程（昭和47年労働省告示第129号）",
    jikou: [
      "圧気工法の知識に関すること。",
      "送気及び排気に関すること。",
      "高気圧障害の知識に関すること。",
  ...
  },
  {
    ...
    jitsugiMin: 180,
    basis:
      "高気圧作業安全衛生規則（昭和47年労働省令第40号）第11条第1項第3号／高気圧業務特別教育規程（昭和47年労働省告示第129号）",
    jikou: [
      "圧気工法の知識に関すること。",
  ...
  },
  {
    ...
    jitsugiMin: 120,
    basis:
      "高気圧作業安全衛生規則（昭和47年労働省令第40号）第11条第1項第4号／高気圧業務特別教育規程（昭和47年労働省告示第129号）",
    jikou: [
      "潜水業務に関する知識に関すること。",
      "送気に関すること。",
      "高気圧障害の知識に関すること。",
  ...
  },
  {
    ...
    /* **教育すべき事項は、規則第11条第2項の表で確かめた**（2026年9月5日・docs/70）。
     ...
     すでに配ってある一覧や CSV の番号がずれる。 */
  {
    ...
    name: "再圧室を操作する業務",
    /* **時間が分からない。**規則第11条は「特別の教育を行わなければならない」と
       教育すべき事項までを決めていて、時間は告示（高気圧業務特別教育規程）の側にある。
       **その告示をうちはまだ見ていない。**
       0 は「教育が要らない」ではなく、「まだ分からない」。 */
    gakkaMin: 0,
    jitsugiMin: 0,
    hoursUnknown: true,
    basis:
      "高気圧作業安全衛生規則（昭和47年労働省令第40号）第11条第1項第5号／高気圧業務特別教育規程（昭和47年労働省告示第129号）",
