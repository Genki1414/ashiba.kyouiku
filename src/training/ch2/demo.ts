...
const WHY: Record<Step["k"], string> = {
  ...
  climb1:
    ...
    "上がったら、まず安全帯を掛ける。手摺がまだ無いうちは、支柱が一番確かな掛け先だ。",
  rail1:
    "床に乗る前に囲いを作る。手摺の無い床の上で手摺を付ける時間が、いちばん落ちる。" +
    "手摺は荷揚げ側から入れると材料を運ぶ距離が短い。" +
    "入れる順は低い方から。踏板から450mmが中さん、900mmが上さん。" +
    "上さんを先に入れると、その下が空いたままになる。体は隙間から抜ける。",
