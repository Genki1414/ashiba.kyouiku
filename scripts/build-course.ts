...
import {
  TAMAKAKE_BASIS, TAMAKAKE_LESSONS, TAMAKAKE_NAME, TAMAKAKE_SUBJECTS, TAMAKAKE_TOTAL_MIN,
} from "../src/content/tamakake";
import {
...
const PLANS: Record<string, Plan> = {
  ...
  crane: {
    ...
    name: `${CRANE_NAME}（学科）`,
    basis: CRANE_BASIS,
    subjects: CRANE_SUBJECTS,
    lessons: CRANE_LESSONS,
    totalMin: CRANE_TOTAL_MIN,
  },
  tamakake: {
    id: "tamakake",
    name: `${TAMAKAKE_NAME}（学科）`,
    basis: TAMAKAKE_BASIS,
    subjects: TAMAKAKE_SUBJECTS,
    lessons: TAMAKAKE_LESSONS,
    totalMin: TAMAKAKE_TOTAL_MIN,
  },
  tokushu: {
    id: "tokushu",
  ...
  tire: {
    ...
    name: `${TIRE_NAME}（学科）`,
    basis: TIRE_BASIS,
    subjects: TIRE_SUBJECTS,
    lessons: TIRE_LESSONS,
    totalMin: TIRE_TOTAL_MIN,
  },
  robotkensa: {
    id: "robotkensa",
  ...
  robotkyoji: {
    id: "robotkyoji",
    name: `${ROBOTKYOJI_NAME}（学科）`,
    basis: ROBOTKYOJI_BASIS,
    subjects: ROBOTKYOJI_SUBJECTS,
    lessons: ROBOTKYOJI_LESSONS,
    totalMin: ROBOTKYOJI_TOTAL_MIN,
  },
  kidou: {
    id: "kidou",
    name: `${KIDOU_NAME}（学科）`,
  ...
  jack: {
    ...
    name: `${JACK_NAME}（学科）`,
    basis: JACK_BASIS,
    subjects: JACK_SUBJECTS,
    lessons: JACK_LESSONS,
    totalMin: JACK_TOTAL_MIN,
  },
  boring: {
    id: "boring",
    name: `${BORING_NAME}（学科）`,
  ...
  concrete: {
    id: "concrete",
    name: `${CONCRETE_NAME}（学科）`,
    basis: CONCRETE_BASIS,
    subjects: CONCRETE_SUBJECTS,
    lessons: CONCRETE_LESSONS,
    totalMin: CONCRETE_TOTAL_MIN,
  },
  kisosousa: {
    id: "kisosousa",
