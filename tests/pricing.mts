...
console.log("── 講座ごとの単価 ──");
{
  ...
  check(unitPrice("soukisensui") === 8500, `${unitPrice("soukisensui")}`);
  check(unitPrice("saiatsushitsu") === 8500, `${unitPrice("saiatsushitsu")}`);
  check(unitPrice("kouatsushitsu") === 7000, `${unitPrice("kouatsushitsu")}`);
  check(unitPrice("senryouka") === 3500, `${unitPrice("senryouka")}`);
  check(unitPrice("josendojo") === 5000, `${unitPrice("josendojo")}`);
  check(unitPrice("josenshushu") === 5000, `${unitPrice("josenshushu")}`);
