...
insert into public.courses (id, name, basis, total_min, sort_order) values
  ...
  ('kogata', '小型車両系建設機械（整地・運搬・積込み用及び掘削用）の運転の業務に係る特別教育', '労働安全衛生法第59条第3項／労働安全衛生規則第36条第9号／安全衛生特別教育規程第11条', 420, 10),
  ('sanketsu', '酸素欠乏・硫化水素危険作業に係る業務に係る特別教育', '労働安全衛生法第59条第3項／酸素欠乏症等防止規則第12条／酸素欠乏危険作業特別教育規程第2条', 330, 11)
on conflict (id) do update
